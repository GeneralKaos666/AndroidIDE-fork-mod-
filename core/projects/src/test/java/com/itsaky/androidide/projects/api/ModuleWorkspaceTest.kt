...
class ModuleWorkspaceTest {
    ...
    fun test() {
        ...
        ToolingApiTestLauncher.launchServer(params) {
            ...
            assertThat(appSourceDirs)
                .doesNotContain(File(rootDir, "other-java-library/src/main/java"))
                        ...
                        filter {
                            it.absolutePath.endsWith("appcompat-1.5.1/jars/classes.jar") ||
                                it.absolutePath.endsWith(
                                    "material-1.8.0-alpha01/jars/classes.jar"
                                ) ||
    ...
    private fun verifyProjectManagerAPIs() {
        ...
        val source =
            root.projectDir
                .toPath()
                .resolve("app/src/main/java/com/itsaky/test/app/MainActivity.java")
        ...
        assertThat(workspace.findModuleForFile(testCls_renamed, true)).isEqualTo(module)
