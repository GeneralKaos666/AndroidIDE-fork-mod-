...
object NavigationBar {
     ...
     * users might change the interaction mode via system settings: System>Gestures>System
     * Navigation. This can lead to conflicts with apps that use specific system-gestures internally
     * for navigation (i. e. swiping), especially if the Android 10 full screen gesture mode is
     * enabled.
     *
     * Before Android P the system has used a classic three button navigation. Starting with Android
     * P a two-button-based interaction mode was introduced (also referred as Android P navigation).
     *
     ...
     * interact with the system (i. e. back-navigation, open the home-screen, changing apps, or
     * toggle a fullscreen mode).
     *
     * Based on
