...
abstract class LogViewFragment :
    ...
    companion object {
        ...
        /**
         * The time duration, in milliseconds which is used to determine whether logs are too
         * frequent or not. If the logs are produced within this time duration, they are considered
         * as too frequent. In this case, the logs are cached and appended in chunks of
         * [MAX_CHUNK_SIZE] characters in size.
         */
        const val LOG_FREQUENCY = 50L

        /**
         * The time duration, in milliseconds we wait before appending the logs. This must be
         * greater than [LOG_FREQUENCY].
         */
        const val LOG_DELAY = 100L

        /**
         * Trim the logs when the number of lines reaches this value. Only [MAX_LINE_COUNT] number
         * of lines are kept in the logs.
         */
