...
class NewFileAction(context: Context, override val order: Int) :
    ...
    private fun doCreateClassFile(
        ...
        val created = doCreateClassFile(binding, file, isKotlin, classTypeId, name, pkgName, node)
    ...
    private fun createAutoLayout(
        ...
        val dir =
            directory.absolutePath.replaceFirst(Regex("java|kotlin/($packagePath)?"), "res/layout/")
        val layoutName =
