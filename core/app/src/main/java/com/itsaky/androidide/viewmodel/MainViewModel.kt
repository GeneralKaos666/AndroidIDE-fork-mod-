...
class MainViewModel : ViewModel() {
    ...
    companion object {
        ...
        // The values assigned to these variables reflect the order in which the screens are
        // presented
        // to the user. A screen with a lower value is displayed before a screen with a higher
        // value.
