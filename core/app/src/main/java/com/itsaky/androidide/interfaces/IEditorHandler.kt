...
interface IEditorHandler {
     ...
     *
     * @param progressConsumer A function which consumes the progress of the save operation. The
     *   first parameter of the function is the current save progress (saved file count) and the
     *   second parameter is the total file count.
     */
