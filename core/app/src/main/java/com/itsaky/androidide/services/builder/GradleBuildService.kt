...
class GradleBuildService :
     ...
     * it may cause memory leaks. Instead, we create another client object which forwards all calls
     * to us. So, when the service is destroyed, we release the reference to the service from this
     * client.
     */
