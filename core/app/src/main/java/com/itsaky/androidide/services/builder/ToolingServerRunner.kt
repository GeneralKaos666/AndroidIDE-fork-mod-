                ...
                try {
                    ...
                    val command =
                        listOf(
                            ...
                            // Allow reflective access to private members of classes in the
                            // following
                            // packages:
                            // - java.lang
                            // - java.io
                            ...
                            // '--add-opens' for 'java.io' (for java.io.File) package, JVM will
                            // throw an
                    ...
                    pid =
                        ReflectionUtils.getDeclaredField(process::class.java, "pid")?.get(process)
                            as Int?
                        ...
                        launch(Dispatchers.IO) {
                            try {
                                ...
                                err.ifCancelledOrInterrupted {
                                    log.info(
                                        "ToolingServerThread has been cancelled or interrupted."
                                    )
                                }
