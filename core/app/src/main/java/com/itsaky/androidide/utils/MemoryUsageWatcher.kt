    ...
    private fun readUsages() {
        ...
        pids.forEach { pid ->
            ...
            memoryUsage[pid]!!.apply {
                // we insert the usage entry at the start of the array, then increment the shift
                // amount by 1
                ...
                // for example, if shift is 1, then _history[0] will actually return _history[1]
                // (index shifted by 1 to the right)
                // when the shift amount exceeds the size of the array, it will be reset to 0
                // (wrapped around)
