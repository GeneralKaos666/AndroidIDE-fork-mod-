...
abstract class AbstractModelBuilder<P, R>(
    ...
    companion object {
        ...
        /**
         * Checks the Android Gradle Plugin version from the given [Versions] model and compares it
         * with [AndroidPluginVersion.MINIMUM_SUPPORTED] and [AndroidPluginVersion.LATEST_TESTED].
         *
         ...
         * @param syncIssueReporter [ISyncIssueReporter] for reporting issues with the Android
        ...
        /**
         * Get the [Versions] information about Android projects. This returns `null` if the project
        ...
        /**
         * Fetches a snapshot of the model of the given type. Throws a [ModelBuilderException] if
         * the model could not be fetched. This also logs the time consumed to fetch the model.
         *
         ...
         * [ModelBuilderException] if the model could not be fetched. This also logs the time
         * consumed to fetch the model.
         *
         * @param target The target element, usually a project.
         * @param modelType The model type.
        ...
        protected fun generateMessage(vararg objects: Any?): String {
            ...
            for (msg in objects) {
                ...
                sb.append(
                    if (msg is Throwable) LogUtils.getFullStackTrace(msg as Throwable?) else msg
                )
            }
            return sb.toString()
        }
