...
internal class ToolingApiServerImpl(private val project: ProjectImpl) : IToolingApiServer {
    ...
    companion object {
         ...
         *
         * This delay should be long enough to let the tooling API stop the daemon but short enough
         * so that the server's process is not kept alive for longer duration.
         */
