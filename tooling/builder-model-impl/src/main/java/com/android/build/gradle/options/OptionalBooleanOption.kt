...
enum class OptionalBooleanOption(
    ...
    /**
     * This project property is read by the firebase plugin, and has no direct impact on AGP
     * behavior.
     *
     * It is included as an OptionalBooleanOption in order that its value, if set, is recorded in
     * the AGP analytics.
     */
    ...
    ENABLE_TEST_FAILURE_RETENTION_COMPRESS_SNAPSHOT(
        "android.experimental.testOptions.emulatorSnapshots.compressSnapshots",
        ApiStage.Experimental,
    ),
    ENABLE_API_MODELING_AND_GLOBAL_SYNTHETICS(
        "android.enableApiModelingAndGlobalSynthetics",
        ApiStage.Experimental,
    ),
    ...
    SERIAL_AAPT2(
        ...
        FeatureStage.Removed(VERSION_BEFORE_4_0, "Invoking AAPT2 serially is no longer supported."),
    );
