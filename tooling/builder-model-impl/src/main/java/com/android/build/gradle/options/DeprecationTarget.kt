...
constructor(
     ...
     *
     * Note that this additional message should be constructed such that it fits well in the overall
     * message:
     *
    ...
    DEX_OPTIONS(
        Version.VERSION_8_0,
        "Using it has no effect, and the Android" + "Gradle plugin optimizes dexing automatically.",
    ),
