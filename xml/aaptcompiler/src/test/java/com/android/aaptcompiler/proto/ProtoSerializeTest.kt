...
class ProtoSerializeTest {
    ...
    fun testSerializeSinglePackage() {
        ...
        // The reference should point to a resource outside of this table to test that both name and
        // id
        // get serialized.
        ...
        Truth.assertThat(
                table.setOverlayable(
                    parseNameOrFail("com.app.a:integer/overlayable"),
                    overlayableItem,
                )
            )
            .isTrue()
    ...
    fun serializeAndDeserializeTableOfPrimitives() {
        ...
        Truth.assertThat(binPrimitive).isNotNull()
        Truth.assertThat(binPrimitive!!.resValue.dataType)
            .isEqualTo(ResValue.DataType.INT_COLOR_RGB8)
        ...
        Truth.assertThat(binPrimitive).isNotNull()
        Truth.assertThat(binPrimitive!!.resValue.dataType)
            .isEqualTo(ResValue.DataType.INT_COLOR_ARGB8)
        ...
        Truth.assertThat(binPrimitive).isNotNull()
        Truth.assertThat(binPrimitive!!.resValue.dataType)
            .isEqualTo(ResValue.DataType.INT_COLOR_RGB4)
        ...
        Truth.assertThat(binPrimitive).isNotNull()
        Truth.assertThat(binPrimitive!!.resValue.dataType)
            .isEqualTo(ResValue.DataType.INT_COLOR_ARGB4)
        ...
        Truth.assertThat(binPrimitive.resValue.data)
            .isEqualTo(tryParseFloat("1.39mm")!!.resValue.data)
