...
class PseudolocalizerTest() {
    ...
    fun testNonHtmlTags() {
        ...
        simpleTest("Started < 1 minute ago", "Started < 1 minute ago", Pseudolocalizer.Method.NONE)
    ...
    fun testHtmlTags() {
        ...
        // The tag (i.e. "a href="idk"") should not be translated, but the inner content
        // (i.e."world")
        // should be.
        simpleTest(
        ...
        // Even if from HTML's point of view the tags are placed incorrectly, the pseudolocalizer
        // should
        // be able to handle them: not translate the tags, and only translate the contents outside
        // and
        // between them.
        simpleTest(
