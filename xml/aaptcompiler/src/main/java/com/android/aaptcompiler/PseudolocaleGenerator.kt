...
data class UnifiedSpan(val tag: String?, var firstChar: Int, var lastChar: Int) :
    ...
    constructor(
        section: UntranslatableSection
    ) : this(null, section.startIndex, section.endIndex - 1)
...
internal fun pseudolocalizeStyledString(
    ...
    while (currentSpanId < mergedSpans.size || spanStack.isNotEmpty()) {
        ...
        if (parentSpan != null) {
            // There is a parent, and either this span is not a child of it, or there are no more
            // spans.
