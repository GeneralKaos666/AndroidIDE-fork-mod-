...
interface ReplaceMethodInsn {
    ...
    /**
     * The descriptor of the method to be replaced. This is the method signature as it appears in
     * the bytecode.
     */
    var methodDescriptor: String

    /**
     * The opcode for the method to be replaced. If this is specified, then the opcode for the
     * invoked method will be checked against this and the invocation will only be replaced of the
     * opcode matches.
     *
    ...
    /**
     * The owner class name for the method which will replace the [methodName]. The class name must
     * be in the form of a fully qualified name or in the binary name format.
     */
    var toClass: String
