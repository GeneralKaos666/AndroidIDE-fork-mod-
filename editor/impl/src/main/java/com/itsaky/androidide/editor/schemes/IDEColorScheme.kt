...
data class StyleDef(
    ...
    /**
     * Make the static style for this style definition. The background color ID in the returned
     * style is always [EditorColorScheme.STATIC_SPAN_BACKGROUND] and the foreground color ID is
     * always [EditorColorScheme.STATIC_SPAN_FOREGROUND].
     */
