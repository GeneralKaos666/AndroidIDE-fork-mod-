...
class ImportCompletionProvider(
     ...
     * segment of [pkgName] is a class, [RequireMemberCompletionException] is thrown to indicate
     * that class members must be completed.
     *
    ...
    /**
     * Collect package nodes from the [trie] for the given [pkgName]. If any segment of [pkgName] is
     * a class, [RequireMemberCompletionException] is thrown to indicate that class members must be
     * completed.
     *
        ...
        for (member in members) {
            ...
            if (
                member.kind == CONSTRUCTOR ||
                    member.kind == STATIC_INIT ||
                    member.kind == INSTANCE_INIT
            ) {
                continue
            }
