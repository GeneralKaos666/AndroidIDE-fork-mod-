    ...
    override suspend fun execAction(data: ActionData): Any {
        ...
        return compiler.compile(file).get { task ->
            ...
            for (member in elements.getAllMembers(element)) {
                if (
                    member.modifiers.contains(Modifier.FINAL) || member.kind != ElementKind.METHOD
                ) {
                    continue
                }
                ...
                if (
                    methodSource.qualifiedName.contentEquals("java.lang.Object") ||
            ...
            for (pointer in checkedMethods) {
                ...
                newImports.removeIf {
                    it.startsWith("java.lang.") ||
                        ...
                        PRIMITIVE_TYPE_KEYWORDS.contains(it) ||
