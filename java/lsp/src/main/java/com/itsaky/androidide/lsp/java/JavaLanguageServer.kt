...
class JavaLanguageServer : ILanguageServer {
    ...
    override fun setupWorkspace(workspace: IWorkspace) {
        ...
        // Using the cached instance will result in completions not being updated for updated
        // resources
    ...
    fun getCompiler(file: Path?): JavaCompilerService {
        ...
        val workspace =
            getInstance().getWorkspace() ?: return JavaCompilerService.NO_MODULE_COMPILER
        val module =
    ...
    fun onContentChange(event: DocumentChangeEvent) {
        ...
        // TODO Find an alternative to efficiently update changeDelta in JavaCompilerService
        // instance
