...
inline fun baseProject(
    ...
    return ProjectTemplateBuilder()
        .apply {
            ...
            // In this phase, we write the build scripts as they may need additional data based on
            // the previous recipe
            // For example, writing settings.gradle[.kts] needs to know the name of the modules so
            // that those can be includedl
            postRecipe = {
                // build.gradle[.kts]
                buildGradle()
