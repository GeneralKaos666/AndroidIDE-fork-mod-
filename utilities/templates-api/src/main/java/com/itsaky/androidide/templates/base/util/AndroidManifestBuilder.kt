...
class AndroidManifestBuilder {
    ...
    /**
     * The name of the string resource to use in the `android:label` attribute of `<application>`
     * tag.
     */
    ...
    /**
     * Whether the manifest is for a library. When set to `true`, some flags like [icon],
     * [roundIcon], [rtl] are ignored.
     */
    var isLibrary = false
