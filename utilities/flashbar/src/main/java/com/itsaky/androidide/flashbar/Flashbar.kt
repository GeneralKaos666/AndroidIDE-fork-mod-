...
class Flashbar private constructor(private var builder: Builder) {
    ...
    class Builder(internal var activity: Activity) {
        ...
        /**
         * Specifies the gravity from where the flashbar will be shown (top/bottom) Default gravity
         * is TOP
         */
        ...
        /**
         * Specifies modal overlay color resource Modal overlay is automatically shown if color is
         * set
         */
        ...
        fun primaryActionText(text: String) = apply {
            require(progressPosition != RIGHT) {
        ...
        fun primaryActionTextColor(@ColorInt color: Int) = apply {
            this.primaryActionTextColor = color
        }
        ...
        fun positiveActionTextSizeInPx(size: Float) = apply {
            this.positiveActionTextSizeInPx = size
        }

        /** Specifies the positive action text size (in sp) */
        fun positiveActionTextSizeInSp(size: Float) = apply {
            this.positiveActionTextSizeInSp = size
        }
        ...
        fun negativeActionTextSizeInPx(size: Float) = apply {
            this.negativeActionTextSizeInPx = size
        }

        /** Specifies the negative action text size (in sp) */
        fun negativeActionTextSizeInSp(size: Float) = apply {
            this.negativeActionTextSizeInSp = size
        }
        ...
        fun showProgress(position: ProgressPosition) = apply {
            ...
            if (progressPosition == LEFT && showIcon) {
                throw IllegalArgumentException(
                    "Cannot show progress at left if icon is already set"
                )
            }
