    ...
    fun `verify included view hierarchy`() {
        inflaterTest {
            requiresActivity {
                ...
                assertThat(included.embedded.hasAttribute("gravity", INamespace.ANDROID.uri))
                    .isTrue()
    ...
    fun `test unsupported views`() {
        inflaterTest {
            requiresActivity {
                ...
                // this takes care of verifying that the generated XML elements will have proper XML
                // tagsl
