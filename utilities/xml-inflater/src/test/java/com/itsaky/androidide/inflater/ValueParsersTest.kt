        ...
        inflaterTest {
            requiresActivity {
                ...
                for (i in units.indices) {
                    assertThat(parseDimension(this, "1" + units[i], -1f).roundToInt())
                        .isEqualTo(results[i])
                }

                // Dimensions from platform resources
                assertThat(parseDimension(this, "@android:dimen/app_icon_size")).isEqualTo(48)
                assertThat(parseDimension(this, "@android:dimen/status_bar_height_portrait"))
                    .isEqualTo(24)

                val exists =
                    try {
                        // The app module here targets android 31 and the dimension resource below
                        // was added in
    ...
    fun `color parser test`() {
        inflaterTest {
            requiresActivity {
                ...
                assertThat(parseColor(this, "@android:color/transparent"))
                    .isEqualTo(Color.TRANSPARENT)
                assertThat(parseColor(this, "@color/test_color"))
                    .isEqualTo(Color.parseColor("#f44336"))
                assertThat(parseColor(this, "@color/test_color_ref"))
                    .isEqualTo(Color.parseColor("#f44336"))
