...
abstract class AbstractParser {
    ...
    protected open fun parseIntegerArray(value: String): IntArray {
        return com.itsaky.androidide.inflater.internal.utils.parseIntegerArray(value)
            ?: intArrayOf()
    }

    /**
     * Parses the given string value representing a boolean or reference to an boolean resource to
     * its actual value.
     *
     * @param value The string value. Usually value from attributes.
     * @param def The default value.
    ...
    /**
     * Parses the given string value representing a reference to a string array resource to its
     * actual value. Returns an empty array if the resource reference cannot be resolved.
     *
     * @param value The string value. Usually value from attributes.
     */
    ...
    /**
     * Parses the given string value representing a color code or reference to a color resource to
     * its actual value.
     *
     * @param value The string value. Usually value from attributes.
     * @param def The default value.
