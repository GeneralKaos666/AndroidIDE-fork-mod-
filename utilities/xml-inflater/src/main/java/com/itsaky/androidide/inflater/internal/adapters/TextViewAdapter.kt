...
open class TextViewAdapter<T : TextView> : ViewAdapter<T>() {
    ...
    override fun createAttrHandlers(create: (String, AttributeHandlerScope<T>.() -> Unit) -> Unit) {
        ...
        create("drawablePadding") {
            view.compoundDrawablePadding = parseDimension(context, value, 0)
        }
        ...
        create("marqueeRepeatLimit") {
            view.marqueeRepeatLimit = parseInteger(value, Int.MAX_VALUE)
        }
