...
private constructor(
     ...
     *
     * Null in the case of a stable version. One of 'alpha', 'beta', 'rc', 'dev' for preview
     * versions.
     *
    ...
    companion object {
        ...
        /**
         * Parses the given AGP version and returns the [AndroidPluginVersion] representing the
         * same.
         */
        @JvmStatic
            ...
            return match.groupValues.run {
                val int =
                    fun(index: Int, default: Int): Int =
                        if (lastIndex >= index)
                            this[index].let { if (it.isBlank()) 0 else it.toInt() }
                        else default

                val str =
                    fun(index: Int, default: String) =
                ...
                return@run AndroidPluginVersion(
                    major,
                    minor,
                    micro,
                    PreviewType.find(previewType),
                    preview,
                )
            }
        }
